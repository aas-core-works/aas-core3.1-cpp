#ifndef AAS_CORE_AAS_3_1_TYPES_GUARD_
#define AAS_CORE_AAS_3_1_TYPES_GUARD_
...
/// \brief Enumeration for denoting whether an asset is a type asset or an instance
...
enum class AssetKind : std::uint32_t {
  ...
  /// \brief Role asset
  kRole = 2,
  /// \brief Neither a type asset nor an instance asset nor a role asset
  kNotApplicable = 3,
...
class IHasKind
 ...
 public:
  ///@{
  /// \brief Kind of the element: either template or instance.
  ///
...
/// semantics as defined in IAssetInformation::global_asset_id.
///
...
class IAssetInformation
 ...
 public:
  ///@{
  /// \brief Denotes whether the Asset is of kind AssetKind::kType,
  /// AssetKind::kInstance, AssetKind::kRole, or
  /// AssetKind::kNotApplicable.
  ...
  ///@{
  /// \brief In case IAssetInformation::asset_kind is AssetKind::kNotApplicable the
  /// IAssetInformation::asset_type is the asset ID of the type asset of the asset under
  /// consideration as identified by IAssetInformation::global_asset_id.
  ///
  /// \note In case IAssetInformation::asset_kind is "Instance" then the IAssetInformation::asset_type denotes
...
/// of an IEntity must be set if Entity/entityType is set to EntityType::kSelfManagedEntity.
class IEntity
    : virtual public ISubmodelElement {
 public:
  ///@{
  ...
  virtual const common::optional<EntityType>& entity_type() const = 0;

  virtual common::optional<EntityType>& mutable_entity_type() = 0;

  virtual void set_entity_type(
    common::optional<EntityType> value
  ) = 0;
...
class RelationshipElement
 ...
 public:
  RelationshipElement(
    ...
    common::optional<
      std::shared_ptr<IReference>
    > first = common::nullopt,
    common::optional<
      std::shared_ptr<IReference>
    > second = common::nullopt
  );
...
class Entity
 ...
 public:
  Entity(
    ...
    common::optional<EntityType> entity_type = common::nullopt,
    common::optional<std::wstring> global_asset_id = common::nullopt,
    common::optional<
      std::vector<
        std::shared_ptr<ISpecificAssetId>
  ...
  const common::optional<EntityType>& entity_type() const override;

  common::optional<EntityType>& mutable_entity_type() override;
 ...
 private:
  ...
  common::optional<EntityType> entity_type_;
...
#endif  // AAS_CORE_AAS_3_1_TYPES_GUARD_
