#ifndef AAS_CORE_AAS_3_1_ENHANCING_GUARD_
#define AAS_CORE_AAS_3_1_ENHANCING_GUARD_
...
class EnhancedEntity
 ...
 public:
  ...
  const common::optional<types::EntityType>& entity_type() const override {
    return instance_->entity_type();
  }

  common::optional<types::EntityType>& mutable_entity_type() override {
    return instance_->mutable_entity_type();
  }

  void set_entity_type(
    common::optional<types::EntityType> value
  ) override {
...
#endif  // AAS_CORE_AAS_3_1_ENHANCING_GUARD_
