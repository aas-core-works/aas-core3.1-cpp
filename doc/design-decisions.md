...
Some structures just "scream" for a dictionary, such as submodel elements property in a @ref aas_core::aas_3_1::types::ISubmodel.
...
For example, an instance of @ref aas_core::aas_3_1::types::ISubmodel may appear in multiple instances of @ref aas_core::aas_3_1::types::IEnvironment.
...
As you can see, say, in @ref aas_core::aas_3_1::types::IProperty class, the `value` property holds strings.
